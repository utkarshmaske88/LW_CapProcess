define([
    'brease/core/Class',
    'widgets/brease/AlarmLine/libs/utils/EditorHandles'
], function (SuperClass, EditorHandles) {
    ...
    var defaultSettings = {},
        ...
        EditorBehaviorClass = SuperClass.extend(function Model(widget) {
            ...
            this.widget.el.append(this.headerWrapper);
        }, defaultSettings),
